...
import mypfp from "../assets/myWthBg.png";
  ...
  return (
    <div className=" text-white flex justify-center items-center w-[90%] gap-[10%] mx-auto mb-14 relative">
      <div className=" relative flex justify-center w-[40%]  ">
        ...
        />
        <img
          className=" h-[350px] z-40 drop-shadow-xl brightness-125 scale-95 "
          src={mypfp}
          alt=""
        />
      </div>
      ...
      <div className=" w-[60%] h-full flex flex-col items-center gap-16 cursor-pointer ">
        <div className=" flex flex-col justify-center items-center gap-5 ">
          <h2 className=" w-full font-bold uppercase tracking-widest text-center text-4xl mb-5 text-[#F2F2F2] hover:text-white title">
        ...
        <div className=" w-full flex gap-5 justify-center">
          <button
            ...
            className=" heartbeat item title font-bold flex items-center gap-5 px-3 py-1 bg-slate-500 rounded text-[#174031] hover:text-[#F2F2F2]">
            My Resume
          </button>
          <Link to={"/contact"}>
